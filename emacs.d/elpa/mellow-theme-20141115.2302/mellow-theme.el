;;; mellow-theme.el --- an Emacs 24 theme based on Mellow (tmTheme)
;;
...
(deftheme mellow
  "mellow-theme - Created by tmtheme-to-deftheme - 2014-11-16 10:26:38 +0800")
...
(custom-theme-set-faces
 ...
 '(default ((t (:foreground "#F8F8F2" :background "#36312C" ))))
 '(region  ((t (:background "#161A1F"))))
 '(cursor  ((t (:background "#F8F8F0"))))

 ;; Temporary defaults
 '(linum                               ((t (:foreground "#5d5954"  :background "#494540" ))))
 '(fringe                              ((t (                       :background "#494540" ))))
 ...
 '(mode-line-inactive                  ((t (:foreground "#d6d6b2"  :background "#494540" :box nil :weight light :inherit (mode-line)   ))))
 '(mode-line                           ((t (:foreground "#f8f8f2"  :background "#494540" :box nil ))))
 ...
 '(font-lock-builtin-face ((t (:foreground "#F8BB39"  ))))
 '(font-lock-variable-name-face ((t (  ))))
 '(font-lock-keyword-face ((t (:foreground "#F2BC79"  ))))
 '(font-lock-type-face ((t (:foreground "#F8BB39"  :underline t))))
 '(font-lock-function-name-face ((t (:foreground "#F28972"  ))))
 '(js3-function-param-face ((t (:foreground "#F8BB39"  :italic t))))
 '(js2-function-param ((t (:foreground "#F8BB39"  :italic t))))
...
;; Rainbow delimiters
 ...
 '(rainbow-delimiters-depth-9-face ((t (:foreground "#999185"))))
